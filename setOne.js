...
// CODE HERE
const nameOfChoice = parameter1 => `the First Parameter is ${parameter1}`

// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
console.log(nameOfChoice(`A T-REX`))
...
// CODE HERE
pricePlusTax = (arrayPrices, cb) =>{
    for(i=0; i<arrayPrices.length; i++){
        (arrayPrices[i] += arrayPrices[i]*.20);
        totalCost.push(arrayPrices[i])
    }
    cb(totalCost)
}
...
// CODE HERE
pricePlusTax(prices,function(totalCost){
